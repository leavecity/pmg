...
Files marked `Status: deprecated` or `Status: archived` are excluded from default context bundles. PMG keeps those files available for audit and cleanup workflows, but inactive memory should not guide normal agent work.
