...
MVP command status:
  implemented: init, status, scan, doctor, diff, context build, memory propose/promote/archive, memory project propose/apply, memory cleanup propose/apply, review create, review memory propose
